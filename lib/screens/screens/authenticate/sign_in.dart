  ...
  void signInWithPhoneAuthCredential(
    ...
    try {
      ...
      if(authCredential?.user != null){
        ...
        await DatabaseService(uid: user.uid).updateUserData(nameController.text, phoneController.text);
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> form_fill()));
      }
