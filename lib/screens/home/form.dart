...
class _form_fillState extends State<form_fill> {
  ...
  Widget _buildName() {
    return TextFormField(
      decoration: InputDecoration(labelText: 'Enter Name', hintText: 'Enter your name'),
  ...
  Widget _buildaddress() {
    return TextFormField(
      decoration: InputDecoration(labelText: 'Enter Address', hintText: 'Enter the Address where help is needed'),
      validator: (String value){
        if(value.isEmpty){
  ...
  Widget _buildphone() {
    return TextFormField(
      decoration: InputDecoration(labelText: 'Enter Phone', hintText: 'Enter an additional phone number'),
      validator: (String value){
        if(value.isEmpty){
  ...
  Widget _buildrequest() {
    return TextFormField(
      decoration: InputDecoration(labelText: 'Enter the request', hintText: 'Enter the help that is needed'),
      validator: (String value){
        if(value.isEmpty){
            ...
            ElevatedButton(
              child: Text('Submit', style: TextStyle(color: Colors.white, fontSize: 16,),),
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Saving Data')));
                   ...
                   print(_name);
                   await DatabaseService(uid: _name+_phoneNumber).updateRequestData(_name, _email, _phoneNumber, _address, _request);
